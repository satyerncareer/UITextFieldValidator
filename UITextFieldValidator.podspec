...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of UITextFieldValidator.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/satyencareer@gmail.com/UITextFieldValidator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'satyencareer@gmail.com' => 'satyendra.chauhan@appster.in' }
  s.source           = { :git => 'https://github.com/satyencareer@gmail.com/UITextFieldValidator.git', :tag => s.version.to_s }
